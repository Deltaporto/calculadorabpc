...
function getPadraoApplyContext() {
  ...
  // ⚡ Optimization: Single-pass native for-loop simultaneously populates context arrays,
  // eliminating intermediate array allocations and O(N*M) nested filter/find traversal overhead.
