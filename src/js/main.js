...
// ⚡ Optimization: Pre-computed hash map for O(1) lookups to avoid Array.prototype.find in hot loops
...
function getPadraoApplyContext() {
  ...
  // ⚡ Optimization: Multi-array population loop avoiding O(N*M) nested `.find()` and multiple `.filter()` overheads
